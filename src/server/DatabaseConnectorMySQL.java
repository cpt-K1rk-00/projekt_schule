 ...
 * anschlie�end SQL-Anweisungen an diese Datenbank gerichtet werden koennen.
 * </p>
 * 
...
public class DatabaseConnectorMySQL{
   ...
   * liefert, so kann dieses Ergebnis anschlie�end mit der Methode getCurrentQueryResult 
   * abgerufen werden.
   */
  public void executeStatement(String pSQLStatement){  
    ...
    try {
      ...
      if (statement.execute(pSQLStatement)) { //Fall 1: Es gibt ein Ergebnis
        ...
        //Statement schlie�en und Ergebnisobjekt erstellen
        statement.close();
